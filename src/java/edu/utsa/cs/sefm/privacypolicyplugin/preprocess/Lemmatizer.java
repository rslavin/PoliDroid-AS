    ...
    public class Lemmatizer {
        ...
        public static LinkedHashMap<String, String> lemmatizeRMap(String inputText) {
            StanfordLemmatizer stLemm = new StanfordLemmatizer();
            LinkedHashMap<String, String> lemmas = new LinkedHashMap<String, String>();
    ...
    class StanfordLemmatizer {
        ...
        public LinkedHashMap<String,String> lemmatizePOS(String text){
            LinkedHashMap<String,String> lemmaPOSMap = new LinkedHashMap<String, String>();
